		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 col-8 align-self-center">
					<h3 class="text-themecolor m-b-0 m-t-0">All ATTENDANCE</h3>
					<ol class="breadcrumb">
				...
				<div class="col-md-12">
					<div class="row col-md-12">
						...
						<div class="search-button" style="float:right;">
							...
							<button href="#" class="btn btn-success" data-toggle="modal" data-target="#add-artist">Add Attendance</button>
