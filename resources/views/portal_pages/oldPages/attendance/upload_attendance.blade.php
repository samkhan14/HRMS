		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 col-8 align-self-center">
					<h3 class="text-themecolor m-b-0 m-t-0">Upload Attendance</h3>
					<ol class="breadcrumb">
			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
                        ...
                        <form method="POST" action="{{url('save-upload-attendance')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                                {{-- <input type="hidden" name="dep_name" value=""> --}}
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="">Upload Attendance</label>
