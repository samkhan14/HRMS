		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 col-8 align-self-center">
					<h3 class="text-themecolor m-b-0 m-t-0">All Departments</h3>
					<ol class="breadcrumb">
					...
					<div class="d-flex m-t-10 justify-content-end">
						<div class="d-flex m-r-20 m-l-10 hidden-md-down">
							<div class="chart-text m-r-10">
								<h6 class="m-b-0"><small>Total Departmentss</small></h6>
				...
				<div class="col-md-12">
					<div class="row col-md-12">
						...
						<div class="search-button" style="float:right;">
							...
							<button href="#" class="btn btn-success" data-toggle="modal" data-target="#add-artist">Add Department</button>
						...
						<div class="table-responsive">
							<table class="table" id="all_record">
								...
								<tbody>
                                  ...
                                  <tr>
                                   <td class="id"></td>
                                    <td class="dep_title"></td>
                                    <td></td>
                                    <td><a href="" class="btn btn-sm btn-icon btn-warning edit" data-toggle="tooltip" title="" data-original-title="Update depignation"><i class="mdi mdi-border-color"></i></a>
                                   {{-- <a href="{{ route('depignations.deptroy', $get_dep->id)}}"  class="btn btn-sm btn-icon btn-danger" style="color:#fff;" data-toggle="tooltip" title="" data-original-title="Delete Artist"><i class="fa fa-trash-alt"></i></a></td> --}}
	 ...
	 <div class="modal fade" id="add-artist" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<form method="post" id="brandForm" name="brandForm" action="{{ route('departments.store')}}" enctype="multipart/form-data">
					@csrf
