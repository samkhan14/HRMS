		...
		<div class="container-fluid">
			<div class="row page-titles">
				<div class="col-md-5 col-8 align-self-center">
					<h3 class="text-themecolor m-b-0 m-t-0">ADD NEW USER EMPLOYEE</h3>
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
						<li class="breadcrumb-item active">ADD NEW USER EMPLOYEE</li>
					</ol>
				</div>
			...
			<div class="col-12">
				...
				<form method="post" id="brandForm" name="brandForm" action="" enctype="multipart/form-data">
					@csrf
