                            ...
                            <tbody>
                                @foreach ($all_employees as $all_emps)
                                    <tr>
                                        ...
                                        <td><a href="{{ isset($all_emps->userinfo->email) ? $all_emps->userinfo->email : 'N/A' }}"
                                                class="__cf_email__"
                                                data-cfemail="046e6b6c6a606b6144617c65697468612a676b69">{{ isset($all_emps->userinfo->email) ? $all_emps->userinfo->email : 'N/A' }}</a>
                                        </td>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item"
                                                        href="{{ url('edit/employee/' . $all_emps->id) }}"><i
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" id="brandForm" name="brandForm" action="{{ url('add-employee-user') }}"
